...
public class DialogManager : MonoBehaviour {
    ...
    private readonly string[] germanLines = new[] { "Willkommen zum Tutorial. Hier erfahren Sie, wie das Spiel funktioniert.", 
        ...
        "Wenn Sie Glück haben, finden Sie ein Insektenspray wie dieses hier. Laufen Sie durch, um es aufzunehmen, und versprühen Sie mit der rechten Maustaste giftiges Insektenspray. Wespen hassen diesen Trick, es macht sie ganz benommen.",
    ...
    "Sometimes you'll be lucky and find an insect spray like this one here. Run through it to pick it up and use your right mouse button to emit toxic insect spray. Wasps hate that trick, it makes them dizzy.",
